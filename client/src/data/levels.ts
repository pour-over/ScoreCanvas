...
const whisperingSandsNodes: Node[] = [
  { id: "ws-intro", type: "musicState", position: { x: 96, y: 390 }, data: { label: "The Scarf Awakens", intensity: 15, looping: false, stems: ["scarf_flap_menacing", "choir_passive_aggressive", "wind_judgmental"], asset: "mus_sands_scarf_awakens_intro", directorNote: "The player should feel at peace. Then we drop the bass and a sand whale eats them." } },
  { id: "ws-explore-1", type: "musicState", position: { x: 544, y: 210 }, data: { label: "Serene Wandering", intensity: 30, looping: true, stems: ["harp_of_doom", "flute_ominous_peace", "strings_deceptive_calm", "perc_sand_shuffle"], asset: "mus_sands_bloodcurdling_serenity_loop" } },
  { id: "ws-explore-2", type: "musicState", position: { x: 544, y: 570 }, data: { label: "False Tranquility", intensity: 25, looping: true, stems: ["kalimba_threat", "pad_sinister_warmth", "bass_lurking"], asset: "mus_sands_false_tranquility_loop" } },
  { id: "ws-trans-to-combat", type: "transition", position: { x: 992, y: 180 }, data: { label: "→ Gentle Hugs", duration: 4000, syncPoint: "next-bar", fadeType: "crossfade" } },
  { id: "ws-combat-lo", type: "musicState", position: { x: 1408, y: 120 }, data: { label: "Tender Violence", intensity: 65, looping: true, stems: ["perc_sand_whale_stomp", "brass_affectionate_violence", "strings_concerned", "synth_dune_rage"], asset: "mus_sands_gentle_hugs_combat_lo" } },
  ...
  { id: "ws-param-scarf", type: "parameter", position: { x: 1408, y: 705 }, data: { label: "ScarfLength", paramName: "RTPC_ScarfLength", minValue: 0, maxValue: 100, defaultValue: 50, description: "Driven by scarf collectibles gathered. Longer scarf = more dramatic flapping stems. At 100 the scarf is a legitimate safety hazard." } },
  ...
  { id: "ws-stinger-cloth", type: "stinger", position: { x: 544, y: 840 }, data: { label: "Cloth Creature RIP", trigger: "OnClothCreatureMurder", asset: "mus_sands_stinger_cloth_creature_death", priority: "high" } },
  { id: "ws-stinger-whale", type: "stinger", position: { x: 992, y: 840 }, data: { label: "Sand Whale Incoming", trigger: "OnSandWhaleAggro", asset: "mus_sands_stinger_sand_whale_spotted", priority: "critical" } },
  { id: "ws-ending", type: "musicState", position: { x: 1824, y: 390 }, data: { label: "Scarf Eulogy", intensity: 40, looping: false, stems: ["strings_weeping_gently", "choir_farewell_scarf", "wind_final_sigh"], asset: "mus_sands_ending_scarf_eulogy" } },
  ...
  { id: "ws-event-checkpoint-dune", type: "event", position: { x: 1824, y: 80 }, data: { label: "Dune Crest Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_DuneCrest_01", description: "Auto-save at the scenic dune overlook, right before the sand whale gauntlet" } },
];
...
const babblingBrookNodes: Node[] = [
  { id: "bb-intro", type: "musicState", position: { x: 96, y: 360 }, data: { label: "Brook Entrance", intensity: 20, looping: false, stems: ["water_drops_ominous", "flute_spa_from_hell", "strings_tension_soothing"], asset: "mus_brook_waters_of_regret_intro", directorNote: "I want the player to feel like they're at a spa. A spa that is on fire." } },
  { id: "bb-explore", type: "musicState", position: { x: 544, y: 210 }, data: { label: "Genocide Waltz", intensity: 35, looping: true, stems: ["harp_babbling", "oboe_mournful_joy", "bass_gentle_menace", "perc_river_stones"], asset: "mus_brook_genocide_waltz_loop" } },
  { id: "bb-trans-to-stealth", type: "transition", position: { x: 544, y: 525 }, data: { label: "→ Stealth", duration: 3000, syncPoint: "next-beat", fadeType: "crossfade" } },
  ...
  { id: "bb-combat-lo", type: "musicState", position: { x: 1392, y: 120 }, data: { label: "Mild Splashing", intensity: 65, looping: true, stems: ["perc_waterfall_slam", "brass_rapids_rage", "strings_undertow", "synth_splash_aggro"], asset: "mus_brook_tranquil_fury_combat_lo" } },
  ...
  { id: "bb-param-moisture", type: "parameter", position: { x: 960, y: 795 }, data: { label: "MoistureLevel", paramName: "RTPC_MoistureLevel", minValue: 0, maxValue: 100, defaultValue: 30, description: "Driven by water proximity and fish aggression. At 100, the player is fully submerged and the reverb goes cathedral. The fish own you now." } },
  ...
  { id: "bb-stinger-fish", type: "stinger", position: { x: 1392, y: 705 }, data: { label: "Fish Attack", trigger: "OnAggressiveFishPet", asset: "mus_brook_stinger_aggressive_fish", priority: "critical" } },
  ...
  { id: "bb-ending", type: "musicState", position: { x: 1760, y: 600 }, data: { label: "Cranberry Sunset", intensity: 45, looping: false, stems: ["strings_spa_closing", "flute_farewell_damp", "water_musical_drain"], asset: "mus_brook_ending_cranberry_sunset" } },
  ...
  { id: "bb-event-checkpoint-bridge", type: "event", position: { x: 1760, y: 900 }, data: { label: "Soggy Bridge Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_SoggyBridge", description: "Auto-save at the rickety bridge over the cranberry-colored rapids" } },
];
...
const tranquilGardensNodes: Node[] = [
  { id: "tg-intro", type: "musicState", position: { x: 96, y: 360 }, data: { label: "Garden Gate", intensity: 15, looping: false, stems: ["music_box_sinister", "strings_thorny", "wind_chime_threatening"], asset: "mus_garden_petal_of_dread_intro" } },
  { id: "tg-explore", type: "musicState", position: { x: 544, y: 240 }, data: { label: "Existential Stroll", intensity: 30, looping: true, stems: ["harp_wilting", "flute_photosynthesis", "bass_root_system", "perc_falling_petals"], asset: "mus_garden_existential_dread_loop" } },
  { id: "tg-trans-to-puzzle", type: "transition", position: { x: 544, y: 570 }, data: { label: "→ Meditation", duration: 3000, syncPoint: "next-bar", fadeType: "crossfade" } },
  ...
  { id: "tg-combat-lo", type: "musicState", position: { x: 1392, y: 120 }, data: { label: "Light Pruning", intensity: 65, looping: true, stems: ["perc_compost_slam", "brass_thorns", "strings_vine_whip", "synth_chlorophyll_rage"], asset: "mus_garden_aggressive_yoga_combat_lo" } },
  ...
  { id: "tg-param-pollen", type: "parameter", position: { x: 96, y: 645 }, data: { label: "PollenDensity", paramName: "RTPC_ExistentialDread", minValue: 0, maxValue: 100, defaultValue: 15, description: "Driven by flower destruction count and proximity to the Garden Heart. At 100, the allergies become the real enemy. Drives sneeze-reverb ambient layer." } },
  { id: "tg-stinger-flower", type: "stinger", position: { x: 960, y: 810 }, data: { label: "Flower Punched", trigger: "OnFlowerPunch", asset: "mus_garden_stinger_flower_punch", priority: "critical" } },
  ...
  { id: "tg-ending", type: "musicState", position: { x: 1760, y: 360 }, data: { label: "Mulch Requiem", intensity: 30, looping: false, stems: ["strings_autumn_acceptance", "flute_final_bloom", "wind_chime_memorial"], asset: "mus_garden_ending_mulch_requiem" } },
...
const cloudNineNodes: Node[] = [
  { id: "cn-intro", type: "musicState", position: { x: 96, y: 390 }, data: { label: "Heaven's Lobby", intensity: 20, looping: false, stems: ["choir_angelic_threat", "harp_cumulus", "synth_celestial_menace"], asset: "mus_cloud_heavens_waiting_room_intro", directorNote: "The clouds should part like the Red Sea. Then close again. On you." } },
  { id: "cn-explore-1", type: "musicState", position: { x: 544, y: 210 }, data: { label: "Chainsaw Lullaby", intensity: 30, looping: true, stems: ["harp_cirrus_drift", "flute_stratosphere", "bass_cloud_density", "perc_raindrop_march"], asset: "mus_cloud_chainsaw_lullaby_loop" } },
  { id: "cn-explore-2", type: "musicState", position: { x: 544, y: 570 }, data: { label: "Nimbus of Regret", intensity: 35, looping: true, stems: ["synth_fog_of_war", "strings_altitude_sickness", "bass_turbulence"], asset: "mus_cloud_nimbus_of_regret_loop" } },
  ...
  { id: "cn-combat-lo", type: "musicState", position: { x: 1408, y: 120 }, data: { label: "Mild Turbulence", intensity: 65, looping: true, stems: ["perc_thunder_tribal", "brass_lightning_bolt", "strings_terminal_velocity", "synth_wind_shear"], asset: "mus_cloud_freefall_of_friendship_combat_lo" } },
  ...
  { id: "cn-stinger-betray", type: "stinger", position: { x: 544, y: 840 }, data: { label: "Cloud Betrayal", trigger: "OnCloudBetray", asset: "mus_cloud_stinger_cloud_betrayal", priority: "high" } },
  { id: "cn-stinger-angel", type: "stinger", position: { x: 992, y: 840 }, data: { label: "Angel Aggro", trigger: "OnAngelRage", asset: "mus_cloud_stinger_angel_rage", priority: "critical" } },
  { id: "cn-ending", type: "musicState", position: { x: 1824, y: 390 }, data: { label: "Gentle Landing of Doom", intensity: 40, looping: false, stems: ["strings_parachute_prayer", "harp_ground_approach", "choir_soft_impact"], asset: "mus_cloud_ending_gentle_landing_of_doom" } },
  ...
  { id: "cn-event-checkpoint-nimbus", type: "event", position: { x: 1824, y: 80 }, data: { label: "Stable Cloud Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_StableNimbus", description: "The one cloud that has signed a legally binding contract not to dissolve. Auto-save here." } },
];
...
const sunsetVistaNodes: Node[] = [
  ...
  { id: "sv-explore", type: "musicState", position: { x: 544, y: 360 }, data: { label: "Scorched Earth Lullaby", intensity: 40, looping: true, stems: ["strings_volcanic_romance", "harp_ember_drift", "synth_magma_glow", "perc_ash_fall"], asset: "mus_sunset_scorched_earth_lullaby_loop" } },
  ...
  { id: "sv-combat-lo", type: "musicState", position: { x: 1376, y: 90 }, data: { label: "Warm Embrace (Light)", intensity: 70, looping: true, stems: ["taiko_eruption", "brass_lava_surge", "strings_heat_death", "synth_molten_bass"], asset: "mus_sunset_warm_embrace_of_death_combat_lo" } },
  { id: "sv-combat-hi", type: "musicState", position: { x: 1376, y: 360 }, data: { label: "Warm Embrace (Fatal)", intensity: 90, looping: true, stems: ["taiko_eruption", "brass_orbital_bombardment", "choir_beautiful_suffering", "synth_molten_bass", "organ_volcano_cathedral"], asset: "mus_sunset_warm_embrace_of_death_combat_hi" } },
  ...
  { id: "sv-boss-p1", type: "musicState", position: { x: 1376, y: 630 }, data: { label: "Volcano Phase 1", intensity: 90, looping: true, stems: ["everything_phase1_scorched"], asset: "mus_sunset_romantic_destruction_boss_p1" } },
  { id: "sv-boss-p2", type: "musicState", position: { x: 1760, y: 630 }, data: { label: "Volcano Phase 2", intensity: 100, looping: true, stems: ["everything_phase2_annihilation"], asset: "mus_sunset_romantic_destruction_boss_p2" } },
  ...
  { id: "sv-stinger-geyser", type: "stinger", position: { x: 960, y: 840 }, data: { label: "Lava Geyser", trigger: "OnLavaGeyserErupt", asset: "mus_sunset_stinger_lava_geyser", priority: "critical" } },
  ...
  { id: "sv-event-volcano-cinematic", type: "event", position: { x: 96, y: 840 }, data: { label: "Volcano Awakens", eventType: "cinematic", blueprintRef: "BP_CinematicTrigger_VolcanoEye", description: "Cinematic: the volcano opens a single massive eye. A tear of lava rolls down its slope. It's beautiful and terrifying." } },
...
const eternalSummitNodes: Node[] = [
  { id: "es-intro", type: "musicState", position: { x: 96, y: 420 }, data: { label: "Summit Gates", intensity: 30, looping: false, stems: ["orchestra_friendship_overture", "synth_celestial_violence", "choir_ancient_bros"], asset: "mus_summit_destroyer_of_worlds_intro", directorNote: "If the player isn't weeping and also terrified, we haven't done our job. This intro should feel like every friendship you've ever had compressed into 40 seconds and then set on fire." } },
  { id: "es-explore", type: "musicState", position: { x: 544, y: 270 }, data: { label: "Companionship & Carnage", intensity: 40, looping: true, stems: ["strings_noble_destruction", "harp_summit_wind", "synth_aurora_threatening", "perc_ice_crystal"], asset: "mus_summit_companionship_and_carnage_loop" } },
  { id: "es-trans-to-combat", type: "transition", position: { x: 960, y: 150 }, data: { label: "→ Heartwarming Slaughter", duration: 3000, syncPoint: "next-bar", fadeType: "crossfade" } },
  { id: "es-combat-lo", type: "musicState", position: { x: 1376, y: 80 }, data: { label: "Friendly Fire", intensity: 70, looping: true, stems: ["perc_avalanche_rhythm", "brass_mountain_fury", "strings_blizzard_passion", "synth_frost_rage"], asset: "mus_summit_combat_heartwarming_slaughter_lo" } },
  { id: "es-combat-hi", type: "musicState", position: { x: 1376, y: 330 }, data: { label: "Best Friends Forever (Literally)", intensity: 90, looping: true, stems: ["perc_avalanche_rhythm", "brass_mountain_full", "choir_frozen_screaming", "synth_frost_rage", "organ_summit_cathedral"], asset: "mus_summit_combat_heartwarming_slaughter_hi" } },
  ...
  { id: "es-boss-p1", type: "musicState", position: { x: 960, y: 630 }, data: { label: "Final Hug P1", intensity: 90, looping: true, stems: ["everything_final_friendship_p1"], asset: "mus_summit_final_hug_of_annihilation_boss_p1" } },
  { id: "es-boss-p2", type: "musicState", position: { x: 1376, y: 630 }, data: { label: "Final Hug P2", intensity: 95, looping: true, stems: ["everything_final_friendship_p2_ascended"], asset: "mus_summit_final_hug_of_annihilation_boss_p2" } },
  ...
  { id: "es-stinger-scarf", type: "stinger", position: { x: 96, y: 840 }, data: { label: "Scarf Convergence", trigger: "OnScarfTrip", asset: "mus_summit_stinger_scarf_convergence", priority: "critical" } },
  { id: "es-victory", type: "musicState", position: { x: 1760, y: 420 }, data: { label: "Friendship Was Violence", intensity: 60, looping: false, stems: ["orchestra_triumph_of_scarves", "choir_eternal_friendship", "synth_aurora_peace", "bell_never_again", "gentle_screaming"], asset: "mus_summit_victory_friendship_was_violence" } },
  ...
  { id: "es-event-checkpoint-peak", type: "event", position: { x: 96, y: 150 }, data: { label: "False Summit Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_FalseSummit", description: "Checkpoint at what the player thinks is the summit. It is not the summit. The real summit is watching." } },
];
