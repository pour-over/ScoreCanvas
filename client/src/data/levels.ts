...
const whisperingSandsNodes: Node[] = [
  { id: "ws-intro", type: "musicState", position: { x: 60, y: 260 }, data: { label: "The Scarf Awakens", intensity: 15, looping: false, stems: ["scarf_flap_menacing", "choir_passive_aggressive", "wind_judgmental"], asset: "mus_sands_scarf_awakens_intro", directorNote: "The player should feel at peace. Then we drop the bass and a sand whale eats them." } },
  { id: "ws-explore-1", type: "musicState", position: { x: 340, y: 140 }, data: { label: "Serene Wandering", intensity: 30, looping: true, stems: ["harp_of_doom", "flute_ominous_peace", "strings_deceptive_calm", "perc_sand_shuffle"], asset: "mus_sands_bloodcurdling_serenity_loop" } },
  { id: "ws-explore-2", type: "musicState", position: { x: 340, y: 380 }, data: { label: "False Tranquility", intensity: 25, looping: true, stems: ["kalimba_threat", "pad_sinister_warmth", "bass_lurking"], asset: "mus_sands_false_tranquility_loop" } },
  { id: "ws-trans-to-combat", type: "transition", position: { x: 620, y: 120 }, data: { label: "→ Gentle Hugs", duration: 4000, syncPoint: "next-bar", fadeType: "crossfade" } },
  { id: "ws-combat-lo", type: "musicState", position: { x: 880, y: 80 }, data: { label: "Tender Violence", intensity: 65, looping: true, stems: ["perc_sand_whale_stomp", "brass_affectionate_violence", "strings_concerned", "synth_dune_rage"], asset: "mus_sands_gentle_hugs_combat_lo" } },
  { id: "ws-combat-hi", type: "musicState", position: { x: 880, y: 280 }, data: { label: "Loving Annihilation", intensity: 90, looping: true, stems: ["perc_sand_whale_stomp", "brass_full_embrace", "choir_screaming_softly", "synth_dune_rage", "scarf_whip_crack"], asset: "mus_sands_gentle_hugs_combat_hi", directorNote: "The choir should sound like they're trying to sing a lullaby while being chased by a sand whale. Comforting yet deeply unsettling." } },
  { id: "ws-param-scarf", type: "parameter", position: { x: 880, y: 470 }, data: { label: "ScarfLength", paramName: "RTPC_ScarfLength", minValue: 0, maxValue: 100, defaultValue: 50, description: "Driven by scarf collectibles gathered. Longer scarf = more dramatic flapping stems. At 100 the scarf is a legitimate safety hazard." } },
  { id: "ws-trans-to-explore", type: "transition", position: { x: 620, y: 340 }, data: { label: "→ False Peace", duration: 6000, syncPoint: "next-bar", fadeType: "bridge" } },
  { id: "ws-stinger-cloth", type: "stinger", position: { x: 340, y: 560 }, data: { label: "Cloth Creature RIP", trigger: "OnClothCreatureMurder", asset: "mus_sands_stinger_cloth_creature_death", priority: "high" } },
  { id: "ws-stinger-whale", type: "stinger", position: { x: 620, y: 560 }, data: { label: "Sand Whale Incoming", trigger: "OnSandWhaleAggro", asset: "mus_sands_stinger_sand_whale_spotted", priority: "critical" } },
  { id: "ws-ending", type: "musicState", position: { x: 1140, y: 260 }, data: { label: "Scarf Eulogy", intensity: 40, looping: false, stems: ["strings_weeping_gently", "choir_farewell_scarf", "wind_final_sigh"], asset: "mus_sands_ending_scarf_eulogy" } },
  { id: "ws-event-opening-cinematic", type: "event", position: { x: 60, y: 80 }, data: { label: "Opening Cinematic", eventType: "cinematic", blueprintRef: "BP_CinematicTrigger_ScarfAwakens", description: "A lone figure rises from the sand. Their scarf billows majestically. A sand whale immediately surfaces behind them.", directorNote: "Hold the beauty shot for exactly three seconds before the sand whale shadow crosses. Comedy is all about timing. The music swell should cut dead when the shadow appears." } },
  { id: "ws-event-cloth-igc", type: "event", position: { x: 620, y: 80 }, data: { label: "First Cloth Creature Murder", eventType: "igc", blueprintRef: "BP_IGC_ClothCreatureMurder_01", description: "In-game cutscene: the player accidentally steps on a cloth creature. It does not survive. The other cloth creatures witness this." } },
  { id: "ws-event-checkpoint-dune", type: "event", position: { x: 1140, y: 80 }, data: { label: "Dune Crest Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_DuneCrest_01", description: "Auto-save at the scenic dune overlook, right before the sand whale gauntlet" } },
];
...
const babblingBrookNodes: Node[] = [
  { id: "bb-intro", type: "musicState", position: { x: 60, y: 240 }, data: { label: "Brook Entrance", intensity: 20, looping: false, stems: ["water_drops_ominous", "flute_spa_from_hell", "strings_tension_soothing"], asset: "mus_brook_waters_of_regret_intro", directorNote: "I want the player to feel like they're at a spa. A spa that is on fire." } },
  { id: "bb-explore", type: "musicState", position: { x: 340, y: 140 }, data: { label: "Genocide Waltz", intensity: 35, looping: true, stems: ["harp_babbling", "oboe_mournful_joy", "bass_gentle_menace", "perc_river_stones"], asset: "mus_brook_genocide_waltz_loop" } },
  { id: "bb-trans-to-stealth", type: "transition", position: { x: 340, y: 350 }, data: { label: "→ Stealth", duration: 3000, syncPoint: "next-beat", fadeType: "crossfade" } },
  { id: "bb-stealth", type: "musicState", position: { x: 600, y: 350 }, data: { label: "Whispered Threats", intensity: 20, looping: true, stems: ["synth_underwater_dread", "perc_drip_tick", "bass_sub_current"], asset: "mus_brook_whispered_threats_stealth", directorNote: "The fish are watching. The music should convey that the fish are always watching. Every drip sound is a fish judging you." } },
  { id: "bb-trans-to-combat", type: "transition", position: { x: 600, y: 140 }, data: { label: "→ Tranquil Fury", duration: 2000, syncPoint: "immediate", fadeType: "sting" } },
  { id: "bb-combat-lo", type: "musicState", position: { x: 870, y: 80 }, data: { label: "Mild Splashing", intensity: 65, looping: true, stems: ["perc_waterfall_slam", "brass_rapids_rage", "strings_undertow", "synth_splash_aggro"], asset: "mus_brook_tranquil_fury_combat_lo" } },
  { id: "bb-combat-hi", type: "musicState", position: { x: 870, y: 280 }, data: { label: "Aggressive Hydration", intensity: 95, looping: true, stems: ["perc_waterfall_slam", "brass_tsunami_embrace", "choir_drowning_harmonies", "synth_splash_aggro", "fish_slap_rhythmic"], asset: "mus_brook_tranquil_fury_combat_hi", directorNote: "The rhythmic fish slapping stem is non-negotiable. It tested well. Do not remove the fish slapping." } },
  { id: "bb-param-moisture", type: "parameter", position: { x: 600, y: 530 }, data: { label: "MoistureLevel", paramName: "RTPC_MoistureLevel", minValue: 0, maxValue: 100, defaultValue: 30, description: "Driven by water proximity and fish aggression. At 100, the player is fully submerged and the reverb goes cathedral. The fish own you now." } },
  { id: "bb-trans-to-explore", type: "transition", position: { x: 1100, y: 200 }, data: { label: "→ Babbling", duration: 5000, syncPoint: "next-bar", fadeType: "bridge" } },
  { id: "bb-stinger-fish", type: "stinger", position: { x: 870, y: 470 }, data: { label: "Fish Attack", trigger: "OnAggressiveFishPet", asset: "mus_brook_stinger_aggressive_fish", priority: "critical" } },
  { id: "bb-stinger-waterfall", type: "stinger", position: { x: 340, y: 530 }, data: { label: "Waterfall Found", trigger: "OnWaterfallApproach", asset: "mus_brook_stinger_waterfall_discovery", priority: "high" } },
  { id: "bb-ending", type: "musicState", position: { x: 1100, y: 400 }, data: { label: "Cranberry Sunset", intensity: 45, looping: false, stems: ["strings_spa_closing", "flute_farewell_damp", "water_musical_drain"], asset: "mus_brook_ending_cranberry_sunset" } },
  { id: "bb-event-qte-fish", type: "event", position: { x: 60, y: 450 }, data: { label: "Aggressive Fish Petting", eventType: "qte", blueprintRef: "BP_QTE_FishPetting_01", description: "QTE sequence: player must pet increasingly hostile fish. Each pet is more aggressive than the last. The final fish requires a running start.", directorNote: "Every QTE button prompt needs a wet slap sound. The music should crescendo with each successful pet. Failed pets should trigger a comedic tuba hit." } },
  { id: "bb-event-waterfall-igc", type: "event", position: { x: 870, y: 600 }, data: { label: "Waterfall Revelation", eventType: "igc", blueprintRef: "BP_IGC_WaterfallSecret_01", description: "In-game cutscene: the waterfall parts to reveal a hidden grotto full of ancient fish bones arranged in a threatening pattern" } },
  { id: "bb-event-checkpoint-bridge", type: "event", position: { x: 1100, y: 600 }, data: { label: "Soggy Bridge Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_SoggyBridge", description: "Auto-save at the rickety bridge over the cranberry-colored rapids" } },
];
...
const tranquilGardensNodes: Node[] = [
  { id: "tg-intro", type: "musicState", position: { x: 60, y: 240 }, data: { label: "Garden Gate", intensity: 15, looping: false, stems: ["music_box_sinister", "strings_thorny", "wind_chime_threatening"], asset: "mus_garden_petal_of_dread_intro" } },
  { id: "tg-explore", type: "musicState", position: { x: 340, y: 160 }, data: { label: "Existential Stroll", intensity: 30, looping: true, stems: ["harp_wilting", "flute_photosynthesis", "bass_root_system", "perc_falling_petals"], asset: "mus_garden_existential_dread_loop" } },
  { id: "tg-trans-to-puzzle", type: "transition", position: { x: 340, y: 380 }, data: { label: "→ Meditation", duration: 3000, syncPoint: "next-bar", fadeType: "crossfade" } },
  { id: "tg-puzzle", type: "musicState", position: { x: 600, y: 380 }, data: { label: "Violent Meditation", intensity: 25, looping: true, stems: ["music_box_contemplative_rage", "synth_zen_fury", "bass_deep_breath"], asset: "mus_garden_violent_meditation_puzzle", directorNote: "Every petal that falls should feel like a small death. Because it literally is. The puzzle stems should evolve — each solved step adds a layer of barely-contained botanical fury." } },
  { id: "tg-trans-to-combat", type: "transition", position: { x: 600, y: 160 }, data: { label: "→ Aggressive Yoga", duration: 2000, syncPoint: "immediate", fadeType: "sting" } },
  { id: "tg-combat-lo", type: "musicState", position: { x: 870, y: 80 }, data: { label: "Light Pruning", intensity: 65, looping: true, stems: ["perc_compost_slam", "brass_thorns", "strings_vine_whip", "synth_chlorophyll_rage"], asset: "mus_garden_aggressive_yoga_combat_lo" } },
  { id: "tg-combat-hi", type: "musicState", position: { x: 870, y: 280 }, data: { label: "Full Deforestation", intensity: 95, looping: true, stems: ["perc_compost_slam", "brass_thorns", "choir_photosynthetic_screaming", "synth_chlorophyll_rage", "taiko_tree_trunk"], asset: "mus_garden_aggressive_yoga_combat_hi", directorNote: "The flowers have had enough. The choir should sound like a greenhouse that has achieved sentience and is furious about it. Think Gregorian chant meets compost heap." } },
  { id: "tg-param-pollen", type: "parameter", position: { x: 60, y: 430 }, data: { label: "PollenDensity", paramName: "RTPC_ExistentialDread", minValue: 0, maxValue: 100, defaultValue: 15, description: "Driven by flower destruction count and proximity to the Garden Heart. At 100, the allergies become the real enemy. Drives sneeze-reverb ambient layer." } },
  { id: "tg-stinger-flower", type: "stinger", position: { x: 600, y: 540 }, data: { label: "Flower Punched", trigger: "OnFlowerPunch", asset: "mus_garden_stinger_flower_punch", priority: "critical" } },
  { id: "tg-stinger-seed", type: "stinger", position: { x: 340, y: 540 }, data: { label: "Secret Seed", trigger: "OnSecretSeedFound", asset: "mus_garden_stinger_secret_seed", priority: "medium" } },
  { id: "tg-ending", type: "musicState", position: { x: 1100, y: 240 }, data: { label: "Mulch Requiem", intensity: 30, looping: false, stems: ["strings_autumn_acceptance", "flute_final_bloom", "wind_chime_memorial"], asset: "mus_garden_ending_mulch_requiem" } },
  { id: "tg-event-floral-revenge", type: "event", position: { x: 60, y: 560 }, data: { label: "The Flowers Fight Back", eventType: "scripted_sequence", blueprintRef: "BP_ScriptedSeq_FloralRevenge_01", description: "Scripted sequence: the garden springs to life, vines erupt from the soil, and a massive sunflower turns to face the player with malicious intent" } },
  { id: "tg-event-topiary-igc", type: "event", position: { x: 870, y: 470 }, data: { label: "Topiary Boss Reveal", eventType: "igc", blueprintRef: "BP_IGC_TopiaryAwakening_01", description: "In-game cutscene: a decorative hedge sculpture peels itself off its frame and assumes a combat stance. It was shaped like a bunny. It is no longer cute." } },
  { id: "tg-event-checkpoint-greenhouse", type: "event", position: { x: 1100, y: 470 }, data: { label: "Greenhouse Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_GreenhouseSafe", description: "The only room in the garden where the plants have been pre-defeated. Safe to save." } },
];
...
const cloudNineNodes: Node[] = [
  { id: "cn-intro", type: "musicState", position: { x: 60, y: 260 }, data: { label: "Heaven's Lobby", intensity: 20, looping: false, stems: ["choir_angelic_threat", "harp_cumulus", "synth_celestial_menace"], asset: "mus_cloud_heavens_waiting_room_intro", directorNote: "The clouds should part like the Red Sea. Then close again. On you." } },
  { id: "cn-explore-1", type: "musicState", position: { x: 340, y: 140 }, data: { label: "Chainsaw Lullaby", intensity: 30, looping: true, stems: ["harp_cirrus_drift", "flute_stratosphere", "bass_cloud_density", "perc_raindrop_march"], asset: "mus_cloud_chainsaw_lullaby_loop" } },
  { id: "cn-explore-2", type: "musicState", position: { x: 340, y: 380 }, data: { label: "Nimbus of Regret", intensity: 35, looping: true, stems: ["synth_fog_of_war", "strings_altitude_sickness", "bass_turbulence"], asset: "mus_cloud_nimbus_of_regret_loop" } },
  { id: "cn-trans-to-combat", type: "transition", position: { x: 620, y: 120 }, data: { label: "→ Freefall", duration: 3000, syncPoint: "next-bar", fadeType: "crossfade" } },
  { id: "cn-combat-lo", type: "musicState", position: { x: 880, y: 80 }, data: { label: "Mild Turbulence", intensity: 65, looping: true, stems: ["perc_thunder_tribal", "brass_lightning_bolt", "strings_terminal_velocity", "synth_wind_shear"], asset: "mus_cloud_freefall_of_friendship_combat_lo" } },
  { id: "cn-combat-hi", type: "musicState", position: { x: 880, y: 280 }, data: { label: "Catastrophic Turbulence", intensity: 95, looping: true, stems: ["perc_thunder_tribal", "brass_lightning_full", "choir_falling_angels", "synth_wind_shear", "organ_cloud_cathedral"], asset: "mus_cloud_freefall_of_friendship_combat_hi", directorNote: "The falling angel choir should sound like a church choir that just realized the floor is gone. Majestic yet deeply concerned. The organ should feel like it's also falling." } },
  { id: "cn-param-altitude", type: "parameter", position: { x: 880, y: 470 }, data: { label: "Altitude", paramName: "RTPC_CloudTrust", minValue: 0, maxValue: 100, defaultValue: 50, description: "Driven by how many clouds have betrayed the player (collapsed underfoot). Starts at 50 (trusting). Decreases with each betrayal. At 0, all clouds are enemies." } },
  { id: "cn-trans-to-explore", type: "transition", position: { x: 620, y: 340 }, data: { label: "→ Drift", duration: 6000, syncPoint: "next-bar", fadeType: "bridge" } },
  { id: "cn-stinger-betray", type: "stinger", position: { x: 340, y: 560 }, data: { label: "Cloud Betrayal", trigger: "OnCloudBetray", asset: "mus_cloud_stinger_cloud_betrayal", priority: "high" } },
  { id: "cn-stinger-angel", type: "stinger", position: { x: 620, y: 560 }, data: { label: "Angel Aggro", trigger: "OnAngelRage", asset: "mus_cloud_stinger_angel_rage", priority: "critical" } },
  { id: "cn-ending", type: "musicState", position: { x: 1140, y: 260 }, data: { label: "Gentle Landing of Doom", intensity: 40, looping: false, stems: ["strings_parachute_prayer", "harp_ground_approach", "choir_soft_impact"], asset: "mus_cloud_ending_gentle_landing_of_doom" } },
  { id: "cn-event-angels-cinematic", type: "event", position: { x: 60, y: 80 }, data: { label: "Angels With Anger Issues", eventType: "cinematic", blueprintRef: "BP_CinematicTrigger_AngryAngels", description: "Full cinematic: the clouds part to reveal a host of angels. They look serene. Then one cracks its knuckles. The halos start spinning like saw blades.", directorNote: "The halo spin-up sound needs to sync with the brass hit at bar 4. The angels' expressions should shift from beatific to murderous exactly on the choir's key change." } },
  { id: "cn-event-cloud-qte", type: "event", position: { x: 620, y: 80 }, data: { label: "Cloud Surfing QTE", eventType: "qte", blueprintRef: "BP_QTE_CloudSurf_01", description: "QTE sequence: player must surf across dissolving clouds while angels throw halos. Miss a jump and you fall through a cloud that was supposed to be solid." } },
  { id: "cn-event-checkpoint-nimbus", type: "event", position: { x: 1140, y: 80 }, data: { label: "Stable Cloud Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_StableNimbus", description: "The one cloud that has signed a legally binding contract not to dissolve. Auto-save here." } },
];
...
const sunsetVistaNodes: Node[] = [
  { id: "sv-intro", type: "musicState", position: { x: 60, y: 240 }, data: { label: "Vista Approach", intensity: 25, looping: false, stems: ["choir_doomsday_serenade", "strings_lament_gorgeous", "bell_apocalypse_toll"], asset: "mus_sunset_last_beautiful_thing_intro", directorNote: "This should feel like the end of a Nicholas Sparks movie. If Nicholas Sparks wrote about orbital bombardment." } },
  { id: "sv-explore", type: "musicState", position: { x: 340, y: 240 }, data: { label: "Scorched Earth Lullaby", intensity: 40, looping: true, stems: ["strings_volcanic_romance", "harp_ember_drift", "synth_magma_glow", "perc_ash_fall"], asset: "mus_sunset_scorched_earth_lullaby_loop" } },
  { id: "sv-trans-to-combat", type: "transition", position: { x: 600, y: 120 }, data: { label: "→ Warm Embrace", duration: 4000, syncPoint: "next-bar", fadeType: "crossfade" } },
  { id: "sv-combat-lo", type: "musicState", position: { x: 860, y: 60 }, data: { label: "Warm Embrace (Light)", intensity: 70, looping: true, stems: ["taiko_eruption", "brass_lava_surge", "strings_heat_death", "synth_molten_bass"], asset: "mus_sunset_warm_embrace_of_death_combat_lo" } },
  { id: "sv-combat-hi", type: "musicState", position: { x: 860, y: 240 }, data: { label: "Warm Embrace (Fatal)", intensity: 90, looping: true, stems: ["taiko_eruption", "brass_orbital_bombardment", "choir_beautiful_suffering", "synth_molten_bass", "organ_volcano_cathedral"], asset: "mus_sunset_warm_embrace_of_death_combat_hi" } },
  { id: "sv-boss-intro", type: "musicState", position: { x: 600, y: 400 }, data: { label: "Romantic Destruction", intensity: 80, looping: false, stems: ["choir_nicholas_sparks_doom", "brass_sunset_cannon", "perc_earth_crack"], asset: "mus_sunset_romantic_destruction_boss_intro", directorNote: "Two seconds of the most beautiful sunset the player has ever seen. Then the volcano opens an eye. Yes, the volcano has an eye now. We're past the point of subtlety." } },
  { id: "sv-boss-p1", type: "musicState", position: { x: 860, y: 420 }, data: { label: "Volcano Phase 1", intensity: 90, looping: true, stems: ["everything_phase1_scorched"], asset: "mus_sunset_romantic_destruction_boss_p1" } },
  { id: "sv-boss-p2", type: "musicState", position: { x: 1100, y: 420 }, data: { label: "Volcano Phase 2", intensity: 100, looping: true, stems: ["everything_phase2_annihilation"], asset: "mus_sunset_romantic_destruction_boss_p2" } },
  { id: "sv-param-heat", type: "parameter", position: { x: 60, y: 420 }, data: { label: "SunsetBeauty", paramName: "RTPC_SunsetBeauty", minValue: 0, maxValue: 100, defaultValue: 80, description: "Paradoxically, beauty increases with destruction. More lava = more beautiful sunset. At 100, the sky is on fire and it's gorgeous and everything is dying." } },
  { id: "sv-stinger-point", type: "stinger", position: { x: 340, y: 500 }, data: { label: "Dramatic Pointing", trigger: "OnSunsetPoint", asset: "mus_sunset_stinger_dramatic_point", priority: "high" } },
  { id: "sv-stinger-geyser", type: "stinger", position: { x: 600, y: 560 }, data: { label: "Lava Geyser", trigger: "OnLavaGeyserErupt", asset: "mus_sunset_stinger_lava_geyser", priority: "critical" } },
  { id: "sv-ending", type: "musicState", position: { x: 1100, y: 240 }, data: { label: "Beautiful Devastation", intensity: 35, looping: false, stems: ["strings_last_sunset", "choir_gorgeous_ruin", "bell_fading_hope", "harp_ash_to_ash"], asset: "mus_sunset_ending_beautiful_devastation", directorNote: "The ending should make the player cry. From beauty, from sadness, from the sheer volume of lava they just survived. All three simultaneously." } },
  { id: "sv-event-qte-sunset", type: "event", position: { x: 340, y: 620 }, data: { label: "Dramatic Sunset Pointing", eventType: "qte", blueprintRef: "BP_QTE_SunsetPoint_01", description: "QTE: The player must dramatically point at the sunset at exactly the right moment. Too early and the sun hasn't set enough. Too late and the volcano blocks the view. There is a 0.3 second window. This is the hardest QTE in the game.", directorNote: "The orchestral swell must peak at the exact frame the player's finger reaches full extension. We have 0.3 seconds. This is our Sistine Chapel moment." } },
  { id: "sv-event-volcano-cinematic", type: "event", position: { x: 60, y: 560 }, data: { label: "Volcano Awakens", eventType: "cinematic", blueprintRef: "BP_CinematicTrigger_VolcanoEye", description: "Cinematic: the volcano opens a single massive eye. A tear of lava rolls down its slope. It's beautiful and terrifying." } },
  { id: "sv-event-checkpoint-ridge", type: "event", position: { x: 1100, y: 560 }, data: { label: "Obsidian Ridge Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_ObsidianRidge", description: "Checkpoint on the cooled obsidian ridge. Everything around you is still on fire but this specific spot is fine." } },
];
...
const eternalSummitNodes: Node[] = [
  { id: "es-intro", type: "musicState", position: { x: 60, y: 280 }, data: { label: "Summit Gates", intensity: 30, looping: false, stems: ["orchestra_friendship_overture", "synth_celestial_violence", "choir_ancient_bros"], asset: "mus_summit_destroyer_of_worlds_intro", directorNote: "If the player isn't weeping and also terrified, we haven't done our job. This intro should feel like every friendship you've ever had compressed into 40 seconds and then set on fire." } },
  { id: "es-explore", type: "musicState", position: { x: 340, y: 180 }, data: { label: "Companionship & Carnage", intensity: 40, looping: true, stems: ["strings_noble_destruction", "harp_summit_wind", "synth_aurora_threatening", "perc_ice_crystal"], asset: "mus_summit_companionship_and_carnage_loop" } },
  { id: "es-trans-to-combat", type: "transition", position: { x: 600, y: 100 }, data: { label: "→ Heartwarming Slaughter", duration: 3000, syncPoint: "next-bar", fadeType: "crossfade" } },
  { id: "es-combat-lo", type: "musicState", position: { x: 860, y: 40 }, data: { label: "Friendly Fire", intensity: 70, looping: true, stems: ["perc_avalanche_rhythm", "brass_mountain_fury", "strings_blizzard_passion", "synth_frost_rage"], asset: "mus_summit_combat_heartwarming_slaughter_lo" } },
  { id: "es-combat-hi", type: "musicState", position: { x: 860, y: 220 }, data: { label: "Best Friends Forever (Literally)", intensity: 90, looping: true, stems: ["perc_avalanche_rhythm", "brass_mountain_full", "choir_frozen_screaming", "synth_frost_rage", "organ_summit_cathedral"], asset: "mus_summit_combat_heartwarming_slaughter_hi" } },
  { id: "es-boss-intro", type: "musicState", position: { x: 340, y: 420 }, data: { label: "The Convergence of Scarves", intensity: 85, looping: false, stems: ["choir_all_scarves_unite", "orchestra_destiny_of_friendship", "synth_singularity_of_hugs"], asset: "mus_summit_final_boss_convergence_intro", directorNote: "Every scarf the player has collected begins to glow and interweave. This is the culmination of the entire Journey. Callback to the Whispering Sands intro motif but now with a full orchestra of friendship and extreme violence." } },
  { id: "es-boss-p1", type: "musicState", position: { x: 600, y: 420 }, data: { label: "Final Hug P1", intensity: 90, looping: true, stems: ["everything_final_friendship_p1"], asset: "mus_summit_final_hug_of_annihilation_boss_p1" } },
  { id: "es-boss-p2", type: "musicState", position: { x: 860, y: 420 }, data: { label: "Final Hug P2", intensity: 95, looping: true, stems: ["everything_final_friendship_p2_ascended"], asset: "mus_summit_final_hug_of_annihilation_boss_p2" } },
  { id: "es-boss-p3", type: "musicState", position: { x: 1100, y: 420 }, data: { label: "Final Hug P3", intensity: 100, looping: true, stems: ["everything_final_friendship_p3_transcendent_violence"], asset: "mus_summit_final_hug_of_annihilation_boss_p3", directorNote: "Everything we have. Every stem, every layer. The tempo increase to 200 BPM should feel like friendship itself accelerating beyond the speed of light. The gentle_screaming stem is mandatory. It tested extraordinarily well." } },
  { id: "es-param-friendship", type: "parameter", position: { x: 60, y: 460 }, data: { label: "FriendshipIntensity", paramName: "RTPC_FriendshipIntensity", minValue: 0, maxValue: 100, defaultValue: 0, description: "Starts at 0. Increases with every violent act of friendship. At 100, friendship has become a force of nature. Drives all combat layer crossfades and the gentle_screaming stem volume." } },
  { id: "es-stinger-scarf", type: "stinger", position: { x: 60, y: 560 }, data: { label: "Scarf Convergence", trigger: "OnScarfTrip", asset: "mus_summit_stinger_scarf_convergence", priority: "critical" } },
  { id: "es-victory", type: "musicState", position: { x: 1100, y: 280 }, data: { label: "Friendship Was Violence", intensity: 60, looping: false, stems: ["orchestra_triumph_of_scarves", "choir_eternal_friendship", "synth_aurora_peace", "bell_never_again", "gentle_screaming"], asset: "mus_summit_victory_friendship_was_violence" } },
  { id: "es-event-convergence-igc", type: "event", position: { x: 340, y: 600 }, data: { label: "The Convergence of Scarves", eventType: "igc", blueprintRef: "BP_IGC_ScarfConvergence_Final", description: "In-game cutscene: every scarf fragment from the entire game converges on the summit, weaving into a massive scarf tornado. It is simultaneously the most beautiful and most terrifying textile event in gaming history." } },
  { id: "es-event-final-qte", type: "event", position: { x: 1100, y: 600 }, data: { label: "Final Friendship Handshake", eventType: "qte", blueprintRef: "BP_QTE_FriendshipHandshake_Final", description: "The final QTE: player must execute a perfectly timed friendship handshake with their Journey companion. The handshake generates a shockwave that levels the mountain. Friendship has consequences.", directorNote: "Each button press adds a layer to the final chord. The handshake impact on the final press must sync with every instrument hitting their final note simultaneously. Then two seconds of silence. Then the gentle_screaming fades in for the credits." } },
  { id: "es-event-checkpoint-peak", type: "event", position: { x: 60, y: 100 }, data: { label: "False Summit Checkpoint", eventType: "checkpoint", blueprintRef: "BP_Checkpoint_FalseSummit", description: "Checkpoint at what the player thinks is the summit. It is not the summit. The real summit is watching." } },
];
