...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "Trans Check vs Full Score",
    content: "Trans Check plays the first and last 10 seconds of each track — perfect for checking transitions. Full Score plays the entire file.",
    placement: "top",
  },
  {
