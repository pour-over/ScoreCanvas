                    ...
                    <tr key={`${asset.id}-detail`} className="bg-canvas-accent/5 border-b border-canvas-accent/20">
                      <td colSpan={8} className="px-5 py-3">
                        <div className="grid grid-cols-3 gap-4">
                          ...
                          {/* Gen Tools */}
                          <div>
                            <div className="text-[9px] font-mono text-canvas-muted uppercase tracking-wider mb-2">AI Tools</div>
                            <div className="space-y-1.5">
                              <button className="w-full px-2.5 py-1.5 text-[10px] font-semibold rounded bg-purple-900/20 text-purple-300 border border-purple-500/20 hover:bg-purple-500/20 text-left flex items-center gap-2">
                                <span className="text-purple-400">✦</span> Generate Variation
                                <span className="text-[8px] text-purple-400/50 ml-auto">AI</span>
                              </button>
                              <button className="w-full px-2.5 py-1.5 text-[10px] font-semibold rounded bg-purple-900/20 text-purple-300 border border-purple-500/20 hover:bg-purple-500/20 text-left flex items-center gap-2">
                              ...
                              <button className="w-full px-2.5 py-1.5 text-[10px] font-semibold rounded bg-amber-900/20 text-amber-300 border border-amber-500/20 hover:bg-amber-500/20 text-left flex items-center gap-2">
                                <span className="text-amber-400">≡</span> Split Stems
                                <span className="text-[8px] text-amber-400/50 ml-auto">AI</span>
                              </button>
                              <button className="w-full px-2.5 py-1.5 text-[10px] font-semibold rounded bg-cyan-900/20 text-cyan-300 border border-cyan-500/20 hover:bg-cyan-500/20 text-left flex items-center gap-2">
                                <span className="text-cyan-400">♪</span> Analyze &amp; Tag
                                <span className="text-[8px] text-cyan-400/50 ml-auto">AI</span>
                              </button>
                            </div>
                          </div>
                        </div>
